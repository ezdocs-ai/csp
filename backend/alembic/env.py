...
from src.database import Base, get_migrations_conn_string
...
from src.ai_providers.schema.ai_provider_model import AiProvider
from src.ai_providers.schema.ai_model_model import AiModel
from src.ai_providers.schema.provider_job_model import ProviderJob
...
config.set_main_option("sqlalchemy.url", get_migrations_conn_string())
...
async def run_migrations_online() -> None:
    ...
    configuration["sqlalchemy.url"] = get_migrations_conn_string()
